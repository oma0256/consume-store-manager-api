...
function calculateCartAmount(price, e){
    // Select cart item
...
function updateCart(e){
  ...
  if(e.target.classList.contains("quantity")){
    ...
    // Execute code if value of quantity is greater than 1
      ...
      const productAmount = parseInt(price.textContent) / parseInt(previousQty.value);
      ...
      totalAmount = parseInt(totalAmount) - parseInt(price.textContent) + cartItemAmount;
